...
export class Streamlines2D {
    ...
    constructor(protoOptions: any) {
        ...
        this.solution = []
        this.streamlineIntegrator = createStreamlineIntegrator(options.seed, this.grid, this.options)
        this.run()
    }
    ...
    private seedStreamline() {
        ...
        if (validCandidate) {
            this.streamlineIntegrator = createStreamlineIntegrator(validCandidate, this.grid, this.options)
